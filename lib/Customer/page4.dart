  ...
  Future<void> checkAuthentication() async {
    ...
    if (mounted) {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => isValid ? ProfileScreen() : LoginButtonScreen(),
        ),
      );
    }
  }
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> fetchProfile() async {
    try {
      var response = await _dioClient.dio.get('http://localhost:5000/api/Customer/profile');
      setState(() {
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            buildProfileItem(Icons.phone, 'Mobile', profileData!['mobileNo']),
                          ],
                        ),
                      ),
                    ],
